...
CREATE TABLE `content` (
  ...
  `contenttitle` varchar(55) DEFAULT NULL,
  `contenturl` varchar(55) DEFAULT NULL,
  `picpath` varchar(55) DEFAULT NULL,
...
insert  into `content`(`contentId`,`contentCategoryId`,`contenttitle`,`contenturl`,`picpath`,`price`,`status`,`createtime`) values (1,2,'现实促销','www.jiyun.cn','1.jpg',500,'启用','2018-11-12 00:00:00');
...
insert  into `contentcategory`(`contentCategoryId`,`categoryname`,`status`,`createtime`) values (1,'产品广告',NULL,NULL),(2,'品牌广告',NULL,NULL),(3,'公益广告',NULL,NULL);
...
insert  into `log`(`logId`,`userName`,`createTime`,`content`,`operation`,`ip`,`module`) values (1,'test','2017-11-29 14:31:04',NULL,'退出',NULL,NULL),(2,'test','2017-11-29 14:31:14',NULL,'登录','192.168.1.17',NULL),(3,'admin','2020-07-31 14:56:21',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(4,'admin','2020-07-31 14:56:21',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(5,'admin','2020-07-31 14:56:22',NULL,'退出',NULL,NULL),(6,'admin','2020-07-31 14:56:27',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(7,'admin','2020-07-31 14:56:27',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(8,'admin','2020-07-31 15:09:58',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(9,'admin','2020-07-31 15:09:58',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(10,'admin','2020-07-31 15:11:37',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(11,'admin','2020-07-31 15:11:37',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(12,'admin','2020-07-31 15:24:27',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(13,'admin','2020-07-31 15:24:27',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(14,'admin','2020-07-31 16:53:31',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(15,'admin','2020-07-31 16:53:31',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(16,'admin','2020-07-31 17:02:20','intercept the method: com.xiaoshu.controller.ContentController.userListnested exception is org.apache.ibatis.reflection.ReflectionException: Could not set property \'contentCategoryId\' of \'class com.xiaoshu.entity.Category\' with value \'2\' Cause: org.apache.ibatis.reflection.ReflectionException: There is no setter for property named \'contentCategoryId\' in \'class com.xiaoshu.entity.Category\'','拦截到异常','0:0:0:0:0:0:0:1','/ssm');
